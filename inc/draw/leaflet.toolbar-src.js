...
L.Toolbar2.ToolbarAction = L.Handler.extend({
	statics: {
	...
	initialize: function(options) {
		var defaultIconOptions = L.Toolbar2.ToolbarAction.prototype.options.toolbarIcon;
...
L.toolbarAction = function toolbarAction(options) {
	return new L.Toolbar2.ToolbarAction(options);
};

L.Toolbar2.ToolbarAction.extendOptions = function(options) {
