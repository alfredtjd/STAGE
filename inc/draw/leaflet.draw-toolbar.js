...
L.Toolbar2.DrawAction = {
    fromHandler: function(Handler, defaultToolbarIcon, defaultSubToolbar) {
        return L.Toolbar2.ToolbarAction.extend({
            options: {
                toolbarIcon: L.extend({}, L.Toolbar2.ToolbarAction.prototype.options.toolbarIcon, defaultToolbarIcon),
                subToolbar: defaultSubToolbar ? defaultSubToolbar : L.Toolbar2.ToolbarAction.prototype.options.subToolbar
            },
            ...
            initialize: function(map, options) {
                ...
                L.Toolbar2.ToolbarAction.prototype.initialize.call(this, options);
            },

            enable: function(e) {
                this._handler.enable();
                L.Toolbar2.ToolbarAction.prototype.enable.call(this, e);
            },

            disable: function() {
                this._handler.disable();
                L.Toolbar2.ToolbarAction.prototype.disable.call(this);
            },

            setOptions: function(options) {
                this._handler.setOptions(options);
                L.Toolbar2.ToolbarAction.prototype.setOptions.call(this, options);
            }
        });
    }
};

L.Toolbar2.DrawAction.Cancel = L.Toolbar2.ToolbarAction.extend({
	options: {
	...
	initialize: function (map, drawing) {
		...
		L.Toolbar2.ToolbarAction.prototype.initialize.call(this);
	},
...
L.Toolbar2.DrawAction.RemoveLastPoint = L.Toolbar2.ToolbarAction.extend({
	options: {
...
L.Toolbar2.EditAction.Control.Save = L.Toolbar2.ToolbarAction.extend({
    options: {
...
L.Toolbar2.EditAction.Control.Undo = L.Toolbar2.ToolbarAction.extend({
    options: {
...
L.Toolbar2.EditAction.Popup.Edit = L.Toolbar2.ToolbarAction.extend({
	options: {
	...
	initialize: function (map, shape, options) {
		...
		L.Toolbar2.ToolbarAction.prototype.initialize.call(this, map, options);
	},
...
L.Toolbar2.EditAction.Popup.Delete = L.Toolbar2.ToolbarAction.extend({
	options: {
